...
graph TB
    ...
    subgraph AWS["AWS Account"]
        subgraph VPC["VPC (10.0.0.0/16)"]
            ...
            subgraph AZ1["Availability Zone 1a"]
                subgraph PubSub1["Public Subnet<br/>10.0.0.0/22"]
                    NAT1[NAT Gateway]
                end
                subgraph PrivSub1["Private Subnet<br/>10.0.32.0/19"]
                    EC2["EC2 Instance<br/>(nginx)"]
                end
            end
            
            subgraph AZ2["Availability Zone 1b"]
                PubSub2["Public Subnet<br/>10.0.4.0/22"]
                PrivSub2["Private Subnet<br/>10.0.64.0/19"]
            end

            subgraph AZ3["Availability Zone 1c"]
                PubSub3["Public Subnet<br/>10.0.8.0/22"]
                PrivSub3["Private Subnet<br/>10.0.96.0/19"]
            end
        end
    end
    ...
    style NAT1 fill:#1e3a8a,stroke:#3b82f6,color:#fff
    style EIP fill:#7f1d1d,stroke:#ef4444,color:#fff
